...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <img alt="wyh开源博客系统" src="${pageContext.request.contextPath}/static/images/logo.png">
        </div>
        <div class="col-md-8">
    ...
    <div class="row">
        <div class="col-md-12" >
            <div align="center" style="padding-top: 120px" >
                <span style="float: left;">Powered by <a  href="http://blog.wyh.com" target="_blank">Java1234</a> V1.0</span>
